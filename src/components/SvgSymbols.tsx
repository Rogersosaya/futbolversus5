  ...
  return (
    <svg id="fv-defs" width="0" height="0" style={{ position: "absolute" }} aria-hidden="true">
      <defs>
        ...
        <symbol id="ic-info" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="12" cy="12" r="9" /><path d="M12 11v5" /><circle cx="12" cy="7.8" r=".9" fill="currentColor" stroke="none" /></symbol>
        ...
        <symbol id="ic-bell" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"><path d="M18 8a6 6 0 1 0-12 0c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.7 21a2 2 0 0 1-3.4 0" /></symbol>
        <symbol id="ic-userplus" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="9" cy="8" r="4" /><path d="M2.5 20c1-4 11-4 12 0M18 8v6M15 11h6" /></symbol>
        ...
        <symbol id="ic-value" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="12" cy="12" r="9" /><path d="M15 9.5a3.5 3.5 0 1 0 0 5M9 11.5h5.5M9 13h5" /></symbol>
